...
with Diagram('pingpong24_pongeventsArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     pong >> Edge( label='ball', **eventedgeattr, decorate='true', fontcolor='red') >> sys
diag
