...
with Diagram('pingpong24_pingeventsArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     ping >> Edge( label='ball', **eventedgeattr, decorate='true', fontcolor='red') >> sys
diag
