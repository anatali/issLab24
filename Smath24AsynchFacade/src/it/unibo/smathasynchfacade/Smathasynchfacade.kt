...
package it.unibo.smathasynchfacade
...
class Smathasynchfacade ( name: String, scope: CoroutineScope, isconfined: Boolean=false  ) : ActorBasicFsm( name, scope, confined=isconfined ){
