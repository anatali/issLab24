...
set JARPATH=%APP_HOME%\lib\unibo.pingpong24-1.0.jar

@rem Execute unibo.pingpong24
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %UNIBO_PINGPONG24_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%UNIBO_PINGPONG24_EXIT_CONSOLE%" exit 1
exit /b 1
