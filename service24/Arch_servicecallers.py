...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     with Cluster('ctxcallers', graph_attr=nodeattr):
          ...
          caller_2=Custom('caller_2','./qakicons/symActorSmall.png')
     ...
     servicedev=Custom('servicedev','./qakicons/server.png')
     caller_2 >> Edge(color='magenta', style='solid', decorate='true', label='<dofibo<font color="darkgreen"> fibodone</font> &nbsp; >',  fontcolor='magenta') >> servicemath
     ...
     caller_2 >> Edge(color='blue', style='solid',  decorate='true', label='<out &nbsp; >',  fontcolor='blue') >> display
