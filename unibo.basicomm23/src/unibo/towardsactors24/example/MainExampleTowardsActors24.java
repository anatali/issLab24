...
public class MainExampleTowardsActors24 {

	
	protected void alienCaller() {
		Alien caller = new Alien("javacaller", ProtocolType.tcp, "localhost", "8123");
		caller.activate();
	}
    ...
    public static void main(String[] args ){
        new MainExampleTowardsActors24().configureTheSystem();
    }
}
