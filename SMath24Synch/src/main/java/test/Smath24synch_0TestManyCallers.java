...
/*
 * ===========================================================================
 * Smath24_0TestManyCallers 
 * ===========================================================================
 */

public class Smath24synch_0TestManyCallers {
	...
	public static void activateCallersUsingGradle() { 
		CommUtils.outmagenta("activateCallersUsingGradle ");		
		Thread th1 = new Thread(){
			public void run(){
				try {
					pcallers = Runtime.getRuntime().exec("./gradlew.bat runManyCallers -x test");
	 ...
	 */
		...
		public static void activate() {
			...
			activateCallersUsingGradle();
  
			CommUtils.delay(6000); //Give time to the application and callers to start ....
 		}
	/*
	 * After  test	
	 */
...
*/
		...
		public void testSmath() {
			IApplMessage req  = CommUtils.buildRequest( "tester", "info", "info(X)", "manycallerobserver");
	 		try {
