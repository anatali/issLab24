...
with Diagram('smath24manycallersArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     with Cluster('ctxsmath', graph_attr=nodeattr):
          smath=Custom('smath(ext)','./qakicons/externalQActor.png')
     clr1 >> Edge( label='startcaller', **eventedgeattr, decorate='true', fontcolor='red') >> clr2
     clr2 >> Edge(color='magenta', style='solid', decorate='true', label='<dofibo<font color="darkgreen"> fibodone</font> &nbsp; >',  fontcolor='magenta') >> smath
     clr1 >> Edge(color='magenta', style='solid', decorate='true', label='<dofibo<font color="darkgreen"> fibodone</font> &nbsp; >',  fontcolor='magenta') >> smath
