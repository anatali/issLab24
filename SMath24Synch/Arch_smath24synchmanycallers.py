...
with Diagram('smath24synchmanycallersArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     with Cluster('ctxmanycallers', graph_attr=nodeattr):
          ...
          manycallerobserver=Custom('manycallerobserver','./qakicons/symActorWithobjSmall.png')
     ...
     clr2 >> Edge(color='blue', style='solid',  decorate='true', label='<callerinfo &nbsp; >',  fontcolor='blue') >> manycallerobserver
     clr1 >> Edge(color='blue', style='solid',  decorate='true', label='<callerinfo &nbsp; >',  fontcolor='blue') >> manycallerobserver
diag
